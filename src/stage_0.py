...
beam_geometry_1 = {
        "length": [0,10],
        "S1": {"y": True, "M": False,  "location": 2},
        "S2": {"y": True, "M": False, "location": 10},
        "S3": {"y": False, "M": True, "location": 8}       # odmah ima x,y oslonce po difoltu jer je uklještenje
}
...
# beam_geometry_1 = {
#         "length": [0,10],
#         "S1": {"y": True, "M": False, "location": 0},
#         "S2": {"y": False, "M": True, "location": 10}       # odmah ima x,y oslonce po difoltu jer je uklještenje
# }
